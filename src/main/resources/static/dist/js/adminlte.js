...
// ===================================================================
// TEMPLATE JAVASCRIPT UNTUK FORM ADMIN
// Versi: 1.0
// ===================================================================

$(document).ready(function () {
  // -------------------------------------------------------------------
  // BAGIAN 1: KONFIGURASI & INISIALISASI DASAR
  // -------------------------------------------------------------------

  // Variabel global dan kunci untuk localStorage (WAJIB DIUBAH DI SETIAP FORM BARU)
  var activeSummernoteInstance = null;
  const formKey = "skemaFormData";
  const formTambahSkema = "#form-tambah-skema";

  // Inisialisasi Toast Notifikasi (SweetAlert2)
  ...
  // Inisialisasi Plugin (Bootstrap, Summernote, dll.)
  ...
  // (Fungsi pendukung yang dipanggil oleh event handler)
  // ===================================================================

  /**
   * Fungsi debounce untuk menunda eksekusi (efisiensi performa).
   */
  ...
  /**
   * Memeriksa apakah ada data yang sudah diinput ke dalam form.
   * @returns {boolean} - True jika ada data, false jika kosong.
   */
  // =======================================================
  // --- FUNGSI UNTUK MERESET FORM KETIKA TEKAN BATAL---
  // =======================================================
  ...
  function isFormDirty() {
    ...
    return false; // Ganti dengan implementasi Anda
  }

  // --- Fungsi khusus Summernote ---
  ...
  // ===================================================================
  // BAGIAN 3: LOGIKA UTAMA (VALIDASI & LOCALSTORAGE)
  // ===================================================================

  /**
   * Fungsi utama untuk memvalidasi satu panel tab.
   * @param {jQuery} tabElement - Elemen jQuery dari .tab-pane.
   * @returns {object} - { isValid: boolean, firstInvalidElement: jQuery|null }.
   */
  ...
  /**
   * Menyimpan semua data dari form ke localStorage.
   */
  ...
  /**
   * Memuat data dari localStorage dan mengisikannya ke form.
   */
  ...
  // ===================================================================
  // BAGIAN 4: EVENT HANDLERS
  // (Kode yang akan berjalan saat ada interaksi dari pengguna)
  // ===================================================================

  // --- A. PEMICU SIMPAN & MUAT DATA ---

  // Panggil fungsi muat data saat halaman pertama kali dibuka
  loadFormDataFromLocalStorage();

  // 1. Buat versi debounced dari fungsi simpan
  ...
  // Validasi saat menekan tombol "Simpan" (Submit)

  // --- TOMBOL SIMPAN (SUBMIT FORM) ---
  $(formTambahSkema).on("submit", function (e) {
  ...
  // 1. Untuk input teks, tanggal, select, dan file biasa ketika validasi real-time
  $(formTambahSkema).on("input change", ".is-invalid", function () {
    const input = $(this);
    if (input.val() && input.val().trim() !== "") {
  ...
  // 2. Untuk Summernote ketika validasi real-time
  ...
  // Event handler untuk tombol 'Hapus' pada baris persyaratan
  ...
  // Event handler untuk toolbar kustom pada Summernote
  ...
  // Event handler untuk tombol 'Tambah' pada baris unit skema
  ...
  // --- C. PEMICU INTERAKSI PENGGUNA LAINNYA ---
