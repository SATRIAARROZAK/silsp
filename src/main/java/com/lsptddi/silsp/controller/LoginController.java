...
import com.lsptddi.silsp.service.AuthService;
import org.springframework.beans.factory.annotation.Autowired;
import org.springframework.stereotype.Controller;
import org.springframework.ui.Model; // Tambahkan import Model
import org.springframework.web.bind.annotation.GetMapping;
import org.springframework.web.bind.annotation.PostMapping;
import org.springframework.web.bind.annotation.RequestParam;
import org.springframework.web.servlet.mvc.support.RedirectAttributes;
...
public class LoginController {
    ...
    public String loginPage(Model model) {
        // Pastikan ini "login" jika nama file Anda login.html
        // Jika Anda menggunakan nama lain, sesuaikan string ini.
        return "login"; 
    }
    ...
    public String processRegistration(
        ...
        try {
            ...
            // Pesan sukses ini akan dikirim ke halaman login
            redirectAttributes.addFlashAttribute("success", "Registrasi berhasil! Silakan login.");
            
            // PENTING: Gunakan "redirect:" untuk memuat ulang ke halaman login
            return "redirect:/login";
