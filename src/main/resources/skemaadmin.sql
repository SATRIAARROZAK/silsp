...
-- Dumping structure for table silsp_db.certification_schemas
CREATE TABLE IF NOT EXISTS `certification_schemas` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `code` varchar(255) COLLATE latin1_bin DEFAULT NULL,
  `document_path` varchar(255) COLLATE latin1_bin DEFAULT NULL,
  `establishment_date` date DEFAULT NULL,
  `level` int DEFAULT NULL,
  `name` varchar(255) COLLATE latin1_bin DEFAULT NULL,
  `no_skkni` varchar(255) COLLATE latin1_bin DEFAULT NULL,
  `skkni_year` varchar(255) COLLATE latin1_bin DEFAULT NULL,
  `schema_mode_id` bigint DEFAULT NULL,
  `schema_type_id` bigint DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `FK7892nnkcf764vikl08o8lv24y` (`schema_mode_id`),
  KEY `FKtguu8eq0rl1b5mo2xccrcvpds` (`schema_type_id`),
  CONSTRAINT `FK7892nnkcf764vikl08o8lv24y` FOREIGN KEY (`schema_mode_id`) REFERENCES `ref_schema_modes` (`id`),
  CONSTRAINT `FKtguu8eq0rl1b5mo2xccrcvpds` FOREIGN KEY (`schema_type_id`) REFERENCES `ref_schema_types` (`id`)
...
-- Dumping structure for table silsp_db.ref_schema_modes
CREATE TABLE IF NOT EXISTS `ref_schema_modes` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `name` varchar(255) COLLATE latin1_bin NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `UK174ytxqp59fggwq0463b36vt7` (`name`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=latin1 COLLATE=latin1_bin;

-- Data exporting was unselected.

-- Dumping structure for table silsp_db.ref_schema_types
CREATE TABLE IF NOT EXISTS `ref_schema_types` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `name` varchar(255) COLLATE latin1_bin NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `UKkxpo4sx10stmdr4rkojn9mkg9` (`name`)
...
-- Dumping structure for table silsp_db.schema_requirements
CREATE TABLE IF NOT EXISTS `schema_requirements` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `description` text COLLATE latin1_bin,
  `schema_id` bigint DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `FKg73tlbsbbbukbtbedxm9yswm9` (`schema_id`),
  CONSTRAINT `FKg73tlbsbbbukbtbedxm9yswm9` FOREIGN KEY (`schema_id`) REFERENCES `certification_schemas` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=41 DEFAULT CHARSET=latin1 COLLATE=latin1_bin;

-- Data exporting was unselected.

-- Dumping structure for table silsp_db.schema_units
CREATE TABLE IF NOT EXISTS `schema_units` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `code` varchar(255) COLLATE latin1_bin DEFAULT NULL,
  `title` varchar(255) COLLATE latin1_bin DEFAULT NULL,
  `schema_id` bigint DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `FKhnjtsqx6e1f3km49xgqq7dish` (`schema_id`),
  CONSTRAINT `FKhnjtsqx6e1f3km49xgqq7dish` FOREIGN KEY (`schema_id`) REFERENCES `certification_schemas` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=97 DEFAULT CHARSET=latin1 COLLATE=latin1_bin;
